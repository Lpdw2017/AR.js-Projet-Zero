...
<body style='margin: 0px'>
	...
	<script>
		...
		if( options.videoSource === 'image_chalk_multi' )	sceneHtml += " sourceType: image; sourceUrl:./images/chalk_multi.jpg;"
		if( options.videoSource === 'image_chalk' )		sceneHtml += " sourceType: image; sourceUrl:./images/chalk.jpg;"
		if( options.videoSource === 'image_img' )		sceneHtml += " sourceType: image; sourceUrl:./images/img.jpg;"
		if( options.videoSource === 'image_kuva' )		sceneHtml += " sourceType: image; sourceUrl:./images/kuva.jpg;"
